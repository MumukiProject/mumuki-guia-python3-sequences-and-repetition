...
* Para resolver la última tarea te puede ser útil escribir algo del estilo `primera_estrofa[aca_va_el_punto_de_partida:]` ¿Y cómo hacer para saber cuál es el primero de los últimos 25 caracteres? Probá restar 25 al largo de la lista :wink:
