class Test(unittest.TestCase):
  ...
  def test_how_many_times_trained_enough_with_15_45_90_equals_2(self):
    self.assertEquals(how_many_times_trained_enough([15, 45, 90]), 2)
    
  def test_how_many_times_trained_enough_with_42_45_43_equals_3(self):
